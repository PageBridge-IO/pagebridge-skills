...
Thanks for your interest in contributing to PageBridge Skills! This guide will help you add new skills or improve existing ones.

## Requesting a Skill

You can also suggest new skills by [opening a skill request](https://github.com/PageBridge-IO/pagebridge-skills/issues/new?template=skill-request.yml).
...
- **Directory name**: lowercase, hyphens only (e.g., `pagebridge-strapi`)
